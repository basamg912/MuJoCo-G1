...
{
    _options.printLevel = PL_LOW;//PL_DEBUG_ITER PL_TABULAR PL_NONE  PL_LOW  PL_MEDIUM   PL_HIGH
}
...
void CQuadraticProgram::SolveQPoases(const int& num_max_iter)
{
    ...
    memcpy(&_H_realt[0], _H.data(), _num_var * _num_var * sizeof(real_t));
    ...
    else//hotstart
    {
        ...
        // Timer::end("QPH");
        // if(Timer::getElapsedTime("QPH")>1.0){
        //     cout<< "\033[1;33m" <<"				                        QPS : "<<Timer::getElapsedTime("QPH")<< "\033[0m"<<endl;
        // }
        // else if(Timer::getElapsedTime("QPH")>.5){
        //     cout<< "\033[1;31m" <<"				                        QPS : "<<Timer::getElapsedTime("QPH")<< "\033[0m"<<endl;
        // }
        // else{
        //     cout<<"				                        QPS : "<<Timer::getElapsedTime("QPH")<<endl;
        // }
